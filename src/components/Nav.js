...
return (
   <Nav>
     <div className={ menuIcon ? "navbar active": "navbar"}>
       ...
       {/* two buttons for opening and closing of that (home,about..) in mobile form */}
...
export default Nav;
// active class converts (about..)horizontal to vertical in mobile view
// navbar toh normal menu icon but if u use navbar active u get the cross button and menu in vertcial way